  ...
  <div class="brand-container">
    <div class="wrap">
      ...
      <section class="mainbox">
        <div class="item left">
          <div class="panel">
            <h2 @click="handleClick(1)">片区开发投资(亿)</h2>
            <business />
            <div class="panel-footer"></div>
          </div>
          <div class="panel">
            <h2 @click="handleClick(2)">土地出让收益（亿）</h2>
            <talent />
            <div class="panel-footer"></div>
          </div>
          <div class="panel">
            <h2 @click="handleClick(3)">片区生产总值（亿）</h2>
            <income />
            <div class="panel-footer"></div>
          </div>
        </div>
...
import PrimaryDevelopment from '../components/changeArea/PrimaryDevelopment.vue'
import SecondaryDevelopment from '../components/changeArea/SecondaryDevelopment.vue'
import TertiaryDevelopment from '../components/changeArea/TertiaryDevelopment.vue'
export default {
  name: 'cycle',
  components: {
    countTo,
  ...
  methods: {
    ...
    handleClick(n) {
     switch (n) {
        case 1:
          this.componetName = "PrimaryDevelopment";
          break;
        case 2:
          this.componetName = "SecondaryDevelopment";
          break;
        case 3:
          this.componetName = "TertiaryDevelopment";
          break;
      }
    },
